<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" class="mt-4">
        ...
        <!-- Email Address -->
        <div>
            <x-input-label for="badge_scan_number" :value="__('Badge')" />
            <x-text-input type="number" name="badge_scan_number" id="badge_scan_number" value="{{ old('badge') }}"
                required autofocus />
        ...
        <div class="flex justify-between mt-4">
            ...
            <div>
                @if (Route::has('password.request'))
                    <a class="block text-sm fontme text-blue-700 hover:underline"
